/**
Advent of Code[About][Events][Shop][Settings][Log Out]Vlad Silin 5*
...
export const solution = (): number => {
  console.log(trySlope(1, 1));
  console.log(trySlope(3, 1)); //159
  console.log(trySlope(5, 1));
  console.log(trySlope(7, 1));
  console.log(trySlope(1, 2));
  return (
    trySlope(1, 1) *
    trySlope(3, 1) *
    trySlope(5, 1) *
